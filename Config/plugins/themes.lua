...
local themes = {
  ...
  "hinterlands", "kanagawa", "kitsune", "last-horizon", "matte-black", "nord",
  "osaka-jade", "retro-82", "ristretto", "rose-pine", "rose-pine-dawn", "rose-pine-moon",
  "tokyo-night", "tokyo-night-storm", "tomorrow-night-burns", "vanta-black",
}
